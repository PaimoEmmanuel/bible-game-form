  ...
  return loading ? (
    ...
    <form className="form" onSubmit={handleSubmit}>
      ...
      <div className="form-field">
        ...
        <span>
          Please select the most appropriate scriptural theme this verse aligns
          with (based on your opinion)
        </span>
        <CreatableSelect
          isMulti
          options={tags}
      ...
      {submitState.error ? <p>An error occured, please try again.</p> : ""}
